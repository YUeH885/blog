...
luci luci-i18n-base-zh-cn luci-i18n-package-manager-zh-cn luci-i18n-firewall-zh-cn luci-i18n-sqm-zh-cn ddns-scripts-cloudflare luci-i18n-ddns-zh-cn openssh-sftp-server tcpdump jq iputils-ping python3 rsync ip-full luci-proto-wireguard" \
FILES="config"
```
